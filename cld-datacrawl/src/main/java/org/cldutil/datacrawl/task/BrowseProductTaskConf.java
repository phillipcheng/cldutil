package org.cldutil.datacrawl.task;
...
import org.cldutil.datacrawl.mgr.CrawlTaskEval;
...
import org.cldutil.xml.taskdef.ParamValueType;
import org.cldutil.xml.taskdef.TaskInvokeType;
...
@Entity
@DiscriminatorValue("org.cldutil.datacrawl.task.BrowseProductTaskConf")
