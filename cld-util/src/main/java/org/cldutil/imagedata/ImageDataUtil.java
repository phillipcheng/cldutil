...
import org.cldutil.xml.imagedata.Data;
import org.cldutil.xml.imagedata.Entry;
...
public class ImageDataUtil {
	...
	public static List<String> getImageFilesFromIdxFile(String strUrl){
		...
		try {
			JAXBContext jc = JAXBContext.newInstance("org.cldutil.xml.imagedata");
