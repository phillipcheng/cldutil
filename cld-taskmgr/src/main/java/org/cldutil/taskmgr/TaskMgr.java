...
import org.cldutil.xml.mytaskdef.ParsedTasksDef;
import org.cldutil.xml.taskdef.BrowseDetailType;
import org.cldutil.xml.taskdef.TasksType;
...
public class TaskMgr {
	...
	public static final String systemTaskClassName="org.cldutil.taskmgr.entity.Task";
	public static final String systemTaskStatClassName="org.cldutil.taskmgr.entity.TaskStat";
	...
	private List<Task> loadTask(TasksType tasks, ClassLoader pluginClassLoader, Map<String, Object> params, Date utime, String confName){
		...
		if (tasks.getPrdTask()!=null){
			String taskType = "org.cldutil.datacrawl.task.BrowseProductTaskConf";
	...
	public List<Task> setUpSite(SiteConf sc, ClassLoader pluginClassLoader, Map<String, Object> params){
		...
		if (confTaskMap.containsKey(id)){
			...
			Date d = sc.getUtime();
			JAXBContext jc = JAXBContext.newInstance("org.cldutil.xml.taskdef");
